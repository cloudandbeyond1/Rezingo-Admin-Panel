...
//Products
const AddProduct = React.lazy(() => import("../pages/Products/AddProducts"));
const ProductsList =  React.lazy(() => import("../pages/Products/ProductList"));

//Practitioners
const AddPractitioners =  React.lazy(() => import("../pages/Practitioners/AddPractitioners"));
const Practitionercontacts =  React.lazy(() => import("../pages/Practitioners/PractitionersList"));

const ContactsProfile1 = React.lazy(() => import("../pages/Profiles"));

//Program

const AddProgram = React.lazy(() => import("../pages/Program/AddProgram")); 
const Programcontacts =  React.lazy(() => import("../pages/Program/ProgramList"));
...
const OrdersList =  React.lazy(() => import("../pages/Order/OrderList"));
...
const dashboardRoutes: RoutesProps = {
  ...
  children: [
    ...
    {
      path: "/AddPractitioners",
      name: "Add Practitioners",
      element: <AddPractitioners />,
      route: PrivateRoute,
    },
    {

      path: "/PractitionersList",

      name: "Practitioners List",

      element: <Practitionercontacts />,
